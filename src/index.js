...
function countryInfo(countries) {
    const markup = countries
        .map(
            country =>
                `<img class = country-img src="${country.flags.svg}" alt="${country.name.official
                }" width="60"><h2>${country.name.official
                }</h2><p class="country-info_description">Capital: <span class="country-info_value">${country.capital
                }</span><p><p class="country-info_description">Population: <span class="country-info_value">${country.population
